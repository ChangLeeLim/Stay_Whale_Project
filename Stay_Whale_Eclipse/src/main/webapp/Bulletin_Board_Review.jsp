						...
						if(val == null) {
							...
							for(int i=0; i<arr.size(); i++) {
								...
								if(arr.get(i).getPost_file().equals("null")) {
									...
									out.println("<div id='thumbnail' style='background-image: url(review_page/" + arr.get(i).getPost_file() + ");'></div>");	
								}
							...
							for(int i=0; i<arr_search.size(); i++) {
								...
								if(arr_search.get(i).getPost_file().equals("null")) {
									...
									out.println("<div id='thumbnail' style='background-image: url(review_page/" + arr_search.get(i).getPost_file() + ");'></div>");	
								}
