...
<link rel="stylesheet" type="text/css" href="css/title_search.css">
<script src="https://ajax.googleapis.com/ajax/libs/jquery/2.2.4/jquery.min.js"></script>
<script src="js/title_search.js"></script>
...
<body>
	...
	<section>
		<div class="top"></div>
		<div><h1 style="font-family: 'Lobster', cursive;">Title Search</h1></div>
		...
		<table style="">
			...
			<%
				ArrayList<Writer> arr = data.title_search(title);
