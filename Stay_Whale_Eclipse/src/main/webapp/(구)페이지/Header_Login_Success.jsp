			...
			<div class="logo_Menu">
				<nav>
					<ul>
						...
						<li><button name="logout" type="button"><a href="dbprocess\Logout.jsp"><div><b>로그아웃</b></div></a></button></li>
						...
						<li><button type="button"><a href="#"><img src="image/login_after.png"></a></button></li>
					</ul>
				</nav>
			</div>
		</div>
