...
<head>
	...
	<link rel="stylesheet" type="text/css" href="css/bulletin_board.css"><!--※css파일 맞는걸로 수정 -->
...
<div class="background" style="display: flex; align-items: center;">
  <p style="width: 1280px; margin: auto; font-family: 'Noto Sans KR', sans-serif; font-size: 60px; color: white; font-weight: bold; text-shadow: 2px 2px 0 #000000;" >1 : 1 문의</p>
</div>
  ...
  <li class="indicator"></li>
    ...
    <section class="article-list table-common con">
		...
		if(id != null)
		{
			...
			{
				out.println("<tr>");
				out.println("<td colspan='4' style='text-align: center; height:500px;'><h1>등록된 1:1문의가 없습니다.</h1></td>");
				out.println("</tr>");
			}
		}
		else
