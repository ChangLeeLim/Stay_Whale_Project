    ...
    <main>
      ...
      <section class="popular_spots">
        ...
        <div class="spot_container">
          <div class="spot_card">
            <img src="image\바다뷰_이미지1.jpg" alt="오션뷰_알아보기">
            <h3>With Ocean</h3>
          ...
          <div class="spot_card">
            <img src="image/산속_이미지1.jpg" alt="산속_알아보기">
            <h3>In the Mountains</h3>
            <p>자연과 함께하는 힐링 캠핑장으로, 시끄러운 도시에서 벗어나 푸른 자연을 만끽하세요.</p>
            <a href="image/Camp_Glam_Reserve.html">
              <button class="spot_button">알아보기</button>
            </a>
          </div>
          <div class="spot_card">
            <img src="image/리버뷰_이미지1.jpg" alt="리버뷰_알아보기">
            <h3>With River</h3>
          ...
          <div class="spot_card">
            <img src="image/카라반_이미지1.jpg" alt="카라반_알아보기">
            <h3>Caravan</h3>
