...
<head>
	...
	<link rel="stylesheet" type="text/css" href="css/bulletin_board_event.css"><!--※css파일 맞는걸로 수정 -->
	<script src="https://ajax.googleapis.com/ajax/libs/jquery/2.2.4/jquery.min.js"></script>
	<script src="js/bulletin_board_event.js"></script>
...
<div class="background" style="display: flex; align-items: center;">
  <p style="width: 1280px; margin: auto; font-family: 'Noto Sans KR', sans-serif; font-size: 60px; color: white; font-weight: bold; text-shadow: 2px 2px 0 #000000;" >이벤트</p>
</div>
