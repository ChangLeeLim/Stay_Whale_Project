		...
		<div id="titleWrap">
			...
			<div id ='contwrap'>
				<div id='cont'>
						...
						<%
							int option = Integer.parseInt((String)request.getParameter("searchOption"));
							String search = (String)request.getParameter("search");
							ArrayList<Bulletin_Board_Free> list= data.contentSearchshow(option, search);		
						...
						<%
							if(option == 1)
							{
								...
								out.println("<option value='1' selected>제목</option>");
								out.println("<option value='2'>작성자</option>");
								out.println("<option value='3'>제목+작성자</option>");
								out.println("</select>");
							}
							else if(option == 2)
						{
							...
							out.println("<option value='2' selected>작성자</option>");
							out.println("<option value='3'>제목+작성자</option>");
							out.println("</select>");
						}
							else if(option == 3)
						{
							...
							out.println("<option value='1'>제목</option>");
							out.println("<option value='2'>작성자</option>");
							out.println("<option value='3' selected>제목+작성자</option>");
							out.println("</select>");
						}
						%>
