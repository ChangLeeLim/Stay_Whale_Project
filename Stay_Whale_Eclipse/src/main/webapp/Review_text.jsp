...
<body>
	...
	<section>
		...
		<div class="form_wrap">
			<form action="dbprocess/review_Insert.jsp" id="myform" onsubmit="return check()">
				...
				<div class="secon_wrap" style="margin-top: 10px;">
					...
					<div>여행지<input type="text" class="location_text" name="travellocation" placeholder="여행지를 입력해주세요"></div>
				</div>
